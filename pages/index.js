...
function Home () {
  return (
    <div>
      ...
      <p className='text-xl font-calibri font-normal mb-6'>Treehous is a new social app where you can post images, text, chat with friends, find new friends, and have fun. <br />
